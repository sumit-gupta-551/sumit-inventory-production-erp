...
class _LoginPageState extends State<LoginPage>
  ...
  Future<void> _loginWithBiometric() async {
    try {
      ...
      if (authenticated) {
        ...
        ErpDatabase.instance.logActivity(
          action: 'LOGIN',
          details: 'Biometric login — ${prefs.getString('user_name') ?? phone}',
        );
        _goToDashboard();
      }
  ...
  Future<void> _loginWithPasscode() async {
    ...
    if (savedHash == null) {
      ...
      ErpDatabase.instance.logActivity(
        action: 'LOGIN',
        details: 'Passcode set & login — ${prefs.getString('user_name') ?? phone}',
      );
      ...
      if (inputHash == savedHash) {
        ...
        ErpDatabase.instance.logActivity(
          action: 'LOGIN',
          details: 'Passcode login — ${prefs.getString('user_name') ?? phone}',
        );
        _goToDashboard();
      } else {
